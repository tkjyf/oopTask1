...
public class JSONArray implements Iterable<Object> {
    ...
    public boolean getBoolean(int index) throws JSONException {
        ...
        if (!object.equals(Boolean.FALSE) && (!(object instanceof String) || !((String)object).equalsIgnoreCase("false"))) {
            if (!object.equals(Boolean.TRUE) && (!(object instanceof String) || !((String)object).equalsIgnoreCase("true"))) {
                throw wrongValueFormatException(index, "boolean", object, (Throwable)null);
            } else {
                return true;
            }
        } else {
    ...
    public <E extends Enum<E>> E getEnum(Class<E> clazz, int index) throws JSONException {
        ...
        if (val == null) {
            throw wrongValueFormatException(index, "enum of type " + JSONObject.quote(clazz.getSimpleName()), this.opt(index), (Throwable)null);
        } else {
            return val;
        }
    }
    ...
    public JSONArray getJSONArray(int index) throws JSONException {
        ...
        if (object instanceof JSONArray) {
            ...
            throw wrongValueFormatException(index, "JSONArray", object, (Throwable)null);
        }
    }
    ...
    public JSONObject getJSONObject(int index) throws JSONException {
        ...
        if (object instanceof JSONObject) {
            ...
            throw wrongValueFormatException(index, "JSONObject", object, (Throwable)null);
        }
    }
    ...
    public String getString(int index) throws JSONException {
        ...
        if (object instanceof String) {
            ...
            throw wrongValueFormatException(index, "String", object, (Throwable)null);
        }
    }
    ...
    public <E extends Enum<E>> E optEnum(Class<E> clazz, int index) {
        return (E) this.optEnum(clazz, index, (Enum)null);
    }
    ...
    public JSONArray optJSONArray(int index) {
        return this.optJSONArray(index, (JSONArray)null);
    }
    ...
    public JSONObject optJSONObject(int index) {
        return this.optJSONObject(index, (JSONObject)null);
    }
    ...
    private static JSONException wrongValueFormatException(int idx, String valueType, Object value, Throwable cause) {
        if (value == null) {
            ...
            return !(value instanceof Map) && !(value instanceof Iterable) && !(value instanceof JSONObject) ? new JSONException("JSONArray[" + idx + "] is not a " + valueType + " (" + value.getClass() + " : " + value + ").", cause) : new JSONException("JSONArray[" + idx + "] is not a " + valueType + " (" + value.getClass() + ").", cause);
        }
    }
}
